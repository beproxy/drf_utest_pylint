...
class OrderSerializer(ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        address_from = AddressFrom.objects.create(**validated_data.pop("address_from"))
        address_to = AddressTo.objects.create(**validated_data.pop("address_to"))
        stuff = Stuff.objects.create(**validated_data.pop("stuff"))
        instance = Order.objects.create(address_from=address_from, user=user, address_to=address_to, stuff=stuff, **validated_data)
        return instance
